...
\ifdefined\ishandout  % Handout Notes.
...
\begin{frame}
    ...
    \begin{center}
      \includegraphics[scale=0.3]{./figures/catarina.png}
    \end{center}
\end{frame}
...
\begin{frame}
    \frametitle{As eras da Exploração Oceanográfica}
    \centerline{\shadowbox{\includegraphics[scale=0.45]{./figures/challenger.png}}}
\end{frame}
...
\begin{frame}
    \frametitle{As eras da Exploração Oceanográfica}
    \centerline{\includegraphics[scale=0.4]{./figures/ano_geofisica.png}}
\end{frame}
