...
\begin{questions}
  ...
  \begin{solution}
    \begin{itemize}
      ...
      \item $S$: Aumenta quase linearmente com o aumento da salinidade.
  ...
  mínimo em $\sim 800$ m e depois torna a crescer mas sem nunca atingir os
  valores da superfície.  O perfil de densidade é quase um espelho da
  ...
  neutra à pouco estável.  Já a termo-/picno-/halo-clina é altamente estável.
    \begin{center}
      \includegraphics[scale=0.5]{./solution/profiles.pdf}
    \end{center}
  \end{solution}
